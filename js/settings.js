...
function confirmReset(){
  confirmAction({
    ...
    message:'This permanently erases ALL your data — subjects, tasks, notes, grades, attendance, habits — and restores the sample starter data. This cannot be undone.',
